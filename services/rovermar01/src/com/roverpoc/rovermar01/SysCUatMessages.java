...
/**
 * SysCUatMessages generated by hbm2java
 */
@Entity
@Table(name="`SysC_uat_messages`"
)

public class SysCUatMessages  implements java.io.Serializable {
...
@Type(type="DateTime")
    ...
    public boolean equals(Object o) {
		 ...
		 if ( !(o instanceof SysCUatMessages) )
		    return false;

		 SysCUatMessages that = (SysCUatMessages) o;
