...
import com.roverpoc.rovermar01.service.NcUatMessagesService;
 ...
 * @see com.roverpoc.rovermar01.NcUatMessages
 */

@RestController(value = "Rovermar01.NcUatMessagesController")
@Api(value = "/rovermar01/NcUatMessages", description = "Exposes APIs to work with NcUatMessages resource.")
@RequestMapping("/rovermar01/NcUatMessages")
public class NcUatMessagesController {
	...
	@Autowired
	@Qualifier("rovermar01.NcUatMessagesService")
