...
import com.roverpoc.rovermar01.service.FilterRulesService;
...
/**
 * Controller object for domain model class FilterRules.
 * @see com.roverpoc.rovermar01.FilterRules
 */

@RestController(value = "Rovermar01.FilterRulesController")
@Api(value = "/rovermar01/FilterRules", description = "Exposes APIs to work with FilterRules resource.")
@RequestMapping("/rovermar01/FilterRules")
public class FilterRulesController {

    private static final Logger LOGGER = LoggerFactory.getLogger(FilterRulesController.class);

	@Autowired
	@Qualifier("rovermar01.FilterRulesService")
	private FilterRulesService filterRulesService;


	@RequestMapping(value = "/search", method = RequestMethod.POST)
	@ApiOperation(value = "Returns the list of FilterRules instances matching the search criteria.")
	public Page<FilterRules> findFilterRuless( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
		LOGGER.debug("Rendering FilterRuless list");
		return filterRulesService.findAll(queryFilters, pageable);
	}

	@RequestMapping(value = "/", method = RequestMethod.GET)
	@ApiOperation(value = "Returns the list of FilterRules instances.")
	public Page<FilterRules> getFilterRuless(Pageable pageable) {
		LOGGER.debug("Rendering FilterRuless list");
	...
	public Long countAllFilterRuless() {
	 ...
	 * @param service
	 */
	protected void setFilterRulesService(FilterRulesService service) {
