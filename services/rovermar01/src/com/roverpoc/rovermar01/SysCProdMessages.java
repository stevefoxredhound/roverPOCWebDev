...
/**
 * SysCProdMessages generated by hbm2java
 */
@Entity
@Table(name="`SysC_prod_messages`"
)

public class SysCProdMessages  implements java.io.Serializable {
...
@Type(type="DateTime")
    ...
    public boolean equals(Object o) {
		 ...
		 if ( !(o instanceof SysCProdMessages) )
		    return false;

		 SysCProdMessages that = (SysCProdMessages) o;
