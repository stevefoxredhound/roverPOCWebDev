...
/**
 * SysBProdMessages generated by hbm2java
 */
@Entity
@Table(name="`SysB_prod_messages`"
)

public class SysBProdMessages  implements java.io.Serializable {
...
@Type(type="DateTime")
    ...
    public boolean equals(Object o) {
		 ...
		 if ( !(o instanceof SysBProdMessages) )
		    return false;

		 SysBProdMessages that = (SysBProdMessages) o;
