...
/**
 * ConnectGmiVennBoth generated by hbm2java
 */
@Entity
@Table(name="`CONNECT_GMI_Venn_Both`"
)

public class ConnectGmiVennBoth  implements java.io.Serializable {

    private BigDecimal count_distinct_coreKey__;

    public ConnectGmiVennBoth() {
    }
    ...
    public boolean equals(Object o) {
		 ...
		 if ( !(o instanceof ConnectGmiVennBoth) )
		    return false;

		 ConnectGmiVennBoth that = (ConnectGmiVennBoth) o;
