 ...
 */
@Service("rovermar01.ResultsService")
public class ResultsServiceImpl implements ResultsService {
    ...
    @Autowired
    @Qualifier("rovermar01.ResultsDao")
    private WMGenericDao<Results, Integer> wmGenericDao;
    public void setWMGenericDao(WMGenericDao<Results, Integer> wmGenericDao){
    ...
    public Results create(Results results) {
        ...
        return this.wmGenericDao.create(results);
    }
    ...
    public Page<Results> findAll(QueryFilter[] queryFilters, Pageable pageable) {
        LOGGER.debug("Finding all resultss");
    ...
    public Results findById(Integer id) throws EntityNotFoundException {
        LOGGER.debug("Finding results by id: {}" , id);
        Results results=this.wmGenericDao.findById(id);
        if(results==null){
            LOGGER.debug("No results found with id: {}" , id);
    ...
    public Results update(Results updated) throws EntityNotFoundException {
        LOGGER.debug("Updating results with information: {}" , updated);
