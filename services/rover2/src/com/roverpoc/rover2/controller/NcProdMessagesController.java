...
import com.roverpoc.rover2.service.NcProdMessagesService;
import java.io.*;
 ...
 * @see com.roverpoc.rover2.NcProdMessages
 */
@RestController(value = "Rover2.NcProdMessagesController")
@RequestMapping("/rover2/NcProdMessages")
@Api(description = "Exposes APIs to work with NcProdMessages resource.", value = "NcProdMessagesController")
public class NcProdMessagesController {
    ...
    @Autowired
    @Qualifier("rover2.NcProdMessagesService")
