...
import com.roverpoc.rover2.service.GmiUatMessagesService;
import java.io.*;
 ...
 */
@RestController(value = "Rover2.GmiUatMessagesController")
@RequestMapping("/rover2/GmiUatMessages")
...
public class GmiUatMessagesController {
    ...
    @Autowired
    @Qualifier("rover2.GmiUatMessagesService")
