...
import com.roverpoc.rover2.service.UserLoginService;
import java.io.*;
 ...
 */
@RestController(value = "Rover2.UserLoginController")
@RequestMapping("/rover2/UserLogin")
@Api(description = "Exposes APIs to work with UserLogin resource.", value = "UserLoginController")
public class UserLoginController {

    private static final Logger LOGGER = LoggerFactory.getLogger(UserLoginController.class);

    @Autowired
    @Qualifier("rover2.UserLoginService")
