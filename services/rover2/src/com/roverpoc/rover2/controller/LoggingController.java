...
import com.roverpoc.rover2.service.LoggingService;
import java.io.*;
 ...
 */
@RestController(value = "Rover2.LoggingController")
@RequestMapping("/rover2/Logging")
@Api(description = "Exposes APIs to work with Logging resource.", value = "LoggingController")
public class LoggingController {

    private static final Logger LOGGER = LoggerFactory.getLogger(LoggingController.class);

    @Autowired
    @Qualifier("rover2.LoggingService")
