...
import  com.roverpoc.rover2.service.Rover2QueryExecutorService;
import com.wavemaker.runtime.data.model.CustomQuery;
import com.wavemaker.runtime.data.exception.QueryParameterMismatchException;
import com.wordnik.swagger.annotations.*;

@RestController(value = "Rover2.QueryExecutionController")
@Api(value = "/rover2/queryExecutor", description = "Controller class for query execution")
@RequestMapping("/rover2/queryExecutor")
public class QueryExecutionController {

	private static final Logger LOGGER = LoggerFactory.getLogger(QueryExecutionController.class);

	@Autowired
	private Rover2QueryExecutorService queryService;
	
	@ApiOperation(value = "Process request to execute queries")
	@RequestMapping(value = "/queries/qryNumberOfSystems", method = RequestMethod.GET)
	public Page<Object> executeQryNumberOfSystems(
		 Pageable pageable)
	    {
			LOGGER.debug("Executing named query qryNumberOfSystems");

		Page<Object> result = queryService.executeQryNumberOfSystems(pageable);
