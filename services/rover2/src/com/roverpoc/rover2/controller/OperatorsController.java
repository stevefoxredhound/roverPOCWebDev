...
import com.roverpoc.rover2.service.OperatorsService;
import java.io.*;
 ...
 */
@RestController(value = "Rover2.OperatorsController")
@RequestMapping("/rover2/Operators")
@Api(description = "Exposes APIs to work with Operators resource.", value = "OperatorsController")
public class OperatorsController {

    private static final Logger LOGGER = LoggerFactory.getLogger(OperatorsController.class);

    @Autowired
    @Qualifier("rover2.OperatorsService")
