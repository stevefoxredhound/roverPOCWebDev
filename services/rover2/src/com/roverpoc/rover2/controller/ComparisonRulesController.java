...
import com.roverpoc.rover2.service.ComparisonRulesService;
import java.io.*;
 ...
 */
@RestController(value = "Rover2.ComparisonRulesController")
@RequestMapping("/rover2/ComparisonRules")
@Api(description = "Exposes APIs to work with ComparisonRules resource.", value = "ComparisonRulesController")
public class ComparisonRulesController {
    ...
    @Autowired
    @Qualifier("rover2.ComparisonRulesService")
